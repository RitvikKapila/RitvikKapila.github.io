        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16 lg:py-24">
          ...
          <section className="md:hidden mb-8 animate-slide-up">
            <div className="flex flex-col items-center gap-6">
              {/* Profile Image */}
              <div className="w-48 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-900 shadow-xl ring-1 ring-gray-200 dark:ring-gray-800">
                <img
              ...
              <div className="grid grid-cols-2 gap-2 w-full max-w-sm">
                <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-900">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800"
                >
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
